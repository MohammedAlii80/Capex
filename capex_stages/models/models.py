...
class crmstagee(models.Model):
    ...
    attachment_att_id = fields.Binary(string="Attachment", required=True)
    attachment_attachment_id = fields.Binary(string="Attachment", required=True)
    ...
    attachment_att_capex_id = fields.Binary(string="Attachment", required=True)
    ...
    investigation_forms_id = fields.Binary(string="Attachment", required=True)
    ...
    risk_app_id = fields.Binary(string="Attachment", required=True)
    risk_inq_id = fields.Binary(string="Attachment", required=True)
    ...
    decision_id = fields.Binary(string="Attachment", required=True)
