...
class crmstagee(models.Model):
    ...
    attachment_att_id = fields.Many2one('ir.attachment', string="Attachment", required=True)
    attachment_attachment_id = fields.Many2one('ir.attachment', string="Attachment", required=True)
    ...
    attachment_att_capex_id = fields.Many2one('ir.attachment', string="Attachment", required=True)
    ...
    investigation_forms_id = fields.Many2one('ir.attachment', string="Attachment", required=True)
    ...
    risk_app_id = fields.Many2one('ir.attachment', string="Attachment", required=True)
    risk_inq_id = fields.Many2one('ir.attachment', string="Attachment", required=True)
    ...
    decision_id = fields.Many2one('ir.attachment', string="Attachment", required=True)
